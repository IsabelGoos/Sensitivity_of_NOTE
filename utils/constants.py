...
elements = {
    ...
    "Li": (3,   6.92), "Be": (4,   9.00),
    "B":  (5,  10.80), "C":  (6,  12.01),
    "N":  (7,  14.01), "O":  (8,  15.999),
    "F":  (9,  19.00), "Ne": (10, 20.19),
    "Na": (11, 23.0), "Mg": (12, 24.305),
    "Al": (13, 26.982), "Si": (14, 28.086),
    "P":  (15, 30.97), "S":  (16, 32.065),
    "Cl": (17, 35.45), "Ar": (18, 39.95),
    "K":  (19, 39.0), "Ca": (20, 40.078),
    "Sc": (21, 45.00), "Ti": (22, 47.0),
    "V":  (23, 51.00), "Cr": (23, 51.996),
    "Mn": (25, 54.94), "Fe": (26, 55.845),
    "Co": (27, 58.90), "Ni": (28, 58.693),
    "Cu": (29, 63.62), "Zn": (30, 65.47),
    "Ga": (31, 69.80), "Ge": (32, 72.72),
    "As": (33, 75.00), "Se": (34, 79.04),
    "Br": (35, 79.90), "Kr": (36, 83.89),
...
# Elements present in the Earth composition
labels_Earth = [
